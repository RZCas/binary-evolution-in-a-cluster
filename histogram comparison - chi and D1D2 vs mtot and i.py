...
input_files = ['1e5','1e6','1e7','1e5,i=89.9','1e6,i=89.9','1e7,i=89.9']
input_files = ['output/chi and D1D2/mtotal='+input_file+'-chiD1D2.txt' for input_file in input_files]
titles = [r'$M_{\rm tot}=10^5M_\odot$, $i=0\dots180^\circ$', r'$M_{\rm tot}=10^6M_\odot$, $i=0\dots180^\circ$', r'$M_{\rm tot}=10^7M_\odot$, $i=0\dots180^\circ$', r'$M_{\rm tot}=10^5M_\odot$, $i=89.9^\circ$', r'$M_{\rm tot}=10^6M_\odot$, $i=89.9^\circ$', r'$M_{\rm tot}=10^7M_\odot$, $i=89.9^\circ$']
...
pyplot.tight_layout()
pyplot.savefig('output/chi and D1D2/chi and D1D2 vs mtot and i.pdf')
pyplot.savefig(str(Path.home())+'/Dropbox/CLUSTERS/chi and D1D2/chi and D1D2 vs mtot and i.pdf')