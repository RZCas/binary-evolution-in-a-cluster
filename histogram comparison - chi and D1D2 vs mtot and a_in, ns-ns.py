...
input_files = ['mtotal=1e5,ns-ns,ain=50','mtotal=1e6,ns-ns,ain=50', 'mtotal=1e5,ns-ns,ain=200','mtotal=1e6,ns-ns,ain=200']
input_files = ['output/chi and D1D2/'+input_file+'-chiD1D2.txt' for input_file in input_files]
titles = [r'$M_{\rm tot}=10^5M_\odot$, $a_{\rm in}=50$ AU', r'$M_{\rm tot}=10^6M_\odot$, $a_{\rm in}=50$ AU', r'$M_{\rm tot}=10^5M_\odot$, $a_{\rm in}=200$ AU', r'$M_{\rm tot}=10^6M_\odot$, $a_{\rm in}=200$ AU']

figure = pyplot.figure(figsize=(12, 8)) 
figure.suptitle(r'Hernquist, $b=a_{\rm out}=2$ pc, $m_{1,2}=1.4M_\odot$')
