...
e01_plot.plot(Qa, e50_01, 'k', label=r'$r_{\rm 3body}=50a$')
e01_plot.plot(Qa, e100_01, 'k--', label=r'$r_{\rm 3body}=100a$')
e01_plot.plot(Qa, e200_01, 'k:', label=r'$r_{\rm 3body}=200a$')
...
e0999_plot.plot(Qa, e50_0999, 'k', label=r'$r_{\rm 3body}=50a$')
e0999_plot.plot(Qa, e100_0999, 'k--', label=r'$r_{\rm 3body}=100a$')
e0999_plot.plot(Qa, e200_0999, 'k:', label=r'$r_{\rm 3body}=200a$')
...
i01_plot.plot(Qa, i50_01, 'k', label=r'$r_{\rm 3body}=50a$')
i01_plot.plot(Qa, i100_01, 'k--', label=r'$r_{\rm 3body}=100a$')
i01_plot.plot(Qa, i200_01, 'k:', label=r'$r_{\rm 3body}=200a$')
...
i0999_plot.plot(Qa, i50_0999, 'k', label=r'$r_{\rm 3body}=50a$')
i0999_plot.plot(Qa, i100_0999, 'k--', label=r'$r_{\rm 3body}=100a$')
i0999_plot.plot(Qa, i200_0999, 'k:', label=r'$r_{\rm 3body}=200a$')
...
omega01_plot.set_xlabel(r'$Q/a$', fontsize=16)
...
omega0999_plot.set_xlabel(r'$Q/a$', fontsize=16)

for plot in [e01_plot, e0999_plot, i01_plot, i0999_plot, omega01_plot, omega0999_plot]:
