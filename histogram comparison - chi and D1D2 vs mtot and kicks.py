...
input_files = ['1e5','1e6','1e7','1e5_nokicks','1e6_nokicks','1e7_nokick']
...
pyplot.tight_layout()
pyplot.savefig('output/chi and D1D2/chi and D1D2 vs mtot and kicks.pdf')
pyplot.savefig(str(Path.home())+'/Dropbox/CLUSTERS/chi and D1D2/chi and D1D2 vs mtot and kicks.pdf')